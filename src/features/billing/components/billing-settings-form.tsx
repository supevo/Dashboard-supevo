...
export function BillingSettingsForm({
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Field name="stage1_name" label="Stage 1 – Name" defaultValue={settings?.stage1_name ?? 'Mitgliedschaft'} />
        <Field
          name="stage1_price"
          ...
          placeholder="4750"
        />
        <Field name="stage2_name" label="Stage 2 – Name" defaultValue={settings?.stage2_name ?? 'Mitgliedschaft Pro'} />
        <Field
          name="stage2_price"
